...
public class Librarian {
    ...
    public static void addBookToLibrary() throws SQLException {
        ...
        System.out.println("Szeretnél új könyvet hozzáadni az adatbázishoz?(i/n)");
...
//        preparedStatement.setString(2, authorID);
            ...
            for (int i = 0; i < parts.length; i++) {
                ...
                preparedStatement.setString(2, oneTheme);
                rows = preparedStatement.executeUpdate();
                System.out.println("kész ");
...
//        connection2.close();
    ...
    public static void discardBook() throws SQLException {
        Scanner sc = new Scanner(System.in);
        System.out.println("Szeretnél könyvet selejtezni?(i/n) ");
        if (sc.nextLine().equals("i")) {
...
//                    "");
    ...
    public static void rentABook() throws SQLException {
        ...
        Connection connection = me.getConnection();
        Scanner sc = new Scanner(System.in);
        System.out.println("Szeretnél új rendelést hozzáadni az adatbázishoz?(i/n)");
        if (sc.nextLine().equals("i")) {
...
//        idáig
    ...
    public static void takeBackABook() throws SQLException {
        ...
        Connection connection = me.getConnection();
        Scanner sc = new Scanner(System.in);
        System.out.println("Szeretnéd  egy könyv visszahozatalának dátumát hozzáadni az adatbázishoz?(i/n)");
        if (sc.nextLine().equals("i")) {
...
// a nem válasz nincs lekezelve itt s még egy helyen asszem
    ...
    public static void createNewUser() throws SQLException {
        ...
        Connection connection = me.getConnection();
        Scanner sc = new Scanner(System.in);
        System.out.println("Szeretnél egy új tagot hozzáadni az adatbázishoz? (i/n)");
        if (sc.nextLine().equals("i")) {
